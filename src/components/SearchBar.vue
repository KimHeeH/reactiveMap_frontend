            ...
            <div v-if="!isSearch">
                <div v-if="user">
                    <div class="successLoginContainer" v-if="!currentComponent">
                        ...
                        <a @click="logout" style="border-bottom: 1px solid black; font-size: 14px">로그아웃</a>
                    </div>
                    <div v-else>
                    ...
                    <div class="menuIconList" v-if="!currentComponent">
                        <div class="iconContainer" v-if="isAuthenticate" @click="currentComponent = 'MyMemoRecords'">
                            <EditIcon />
                            <div>나의 메모 기록</div>
                        </div>
                        <div class="iconContainer" :userdata="user" @click="currentComponent = 'MyTimeLine'">
                            <ChartLineIcon />
                            <div>내 타임라인</div>
                        </div>
                        <div class="iconContainer" :userData="user" @click="currentComponent = 'MyAlaram'">
                            <AlaramIcon />
                            <div>알림 설정 내역</div>
                        </div>
                        <div class="iconContainer" :userData="user" @click="currentComponent = 'MySaved'">
                            <BookMarkIcon />
                            <div>저장됨</div>
                        </div>
                    </div>
